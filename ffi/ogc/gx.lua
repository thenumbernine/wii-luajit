 ...
 * @{
 */
enum { GX_CLIP_DISABLE = 1 };
enum { GX_CLIP_ENABLE = 0 };
/*! @} */

enum { GX_FIFO_MINSIZE = (64*1024) };			/*!< Smallest usable graphics FIFO size. */
enum { GX_FIFO_HIWATERMARK = (16*1024) };			/*!< Default hi watermark for FIFO buffer control. */
enum { GX_FIFO_OBJSIZE = 128 };

enum { GX_PERSPECTIVE = 0 };
enum { GX_ORTHOGRAPHIC = 1 };

enum { GX_MT_NULL = 0 };
enum { GX_MT_XF_FLUSH = 1 };
enum { GX_MT_DL_SAVE_CTX = 2 };

enum { GX_XF_FLUSH_NONE = 0 };
enum { GX_XF_FLUSH_SAFE = 1 };
...
enum { GX_COLOR1A1 = 5 };
enum { GX_COLORZERO = 6 };
enum { GX_ALPHA_BUMP = 7 };
enum { GX_ALPHA_BUMPN = 8 };
enum { GX_COLORNULL = 0xff };
/*! @} */
 ...
 * @{
 */
enum { GX_NONE = 0 };			/*!< Input data is not used */
enum { GX_DIRECT = 1 };			/*!< Input data is set direct */
enum { GX_INDEX8 = 2 };			/*!< Input data is set by a 8bit index */
enum { GX_INDEX16 = 3 };			/*!< Input data is set by a 16bit index */
 ...
 * @{
 */
enum { GX_U8 = 0 };			/*!< Unsigned 8-bit integer */
enum { GX_S8 = 1 };			/*!< Signed 8-bit integer */
enum { GX_U16 = 2 };			/*!< Unsigned 16-bit integer */
enum { GX_S16 = 3 };			/*!< Signed 16-bit integer */
enum { GX_F32 = 4 };			/*!< 32-bit floating-point */
enum { GX_RGB565 = 0 };			/*!< 16-bit RGB */
enum { GX_RGB8 = 1 };			/*!< 24-bit RGB */
enum { GX_RGBX8 = 2 };			/*!< 32-bit RGBX */
enum { GX_RGBA4 = 3 };			/*!< 16-bit RGBA */
enum { GX_RGBA6 = 4 };			/*!< 24-bit RGBA */
enum { GX_RGBA8 = 5 };			/*!< 32-bit RGBA */
/*! @} */

/*! \addtogroup comptype Attribute component type
 * @{
 */
enum { GX_POS_XY = 0 };			/*!< X,Y position */
enum { GX_POS_XYZ = 1 };			/*!< X,Y,Z position */
enum { GX_NRM_XYZ = 0 };			/*!< X,Y,Z normal */
enum { GX_NRM_NBT = 1 };
enum { GX_NRM_NBT3 = 2 };
enum { GX_CLR_RGB = 0 };			/*!< RGB color */
enum { GX_CLR_RGBA = 1 };			/*!< RGBA color */
enum { GX_TEX_S = 0 };			/*!< One texture dimension */
enum { GX_TEX_ST = 1 };			/*!< Two texture dimensions */
/*! @} */

/*! \addtogroup vtxattr Vertex attribute array type
 * @{
 */
enum { GX_VA_PTNMTXIDX = 0 };
enum { GX_VA_TEX0MTXIDX = 1 };
enum { GX_VA_TEX1MTXIDX = 2 };
enum { GX_VA_TEX2MTXIDX = 3 };
enum { GX_VA_TEX3MTXIDX = 4 };
enum { GX_VA_TEX4MTXIDX = 5 };
enum { GX_VA_TEX5MTXIDX = 6 };
enum { GX_VA_TEX6MTXIDX = 7 };
enum { GX_VA_TEX7MTXIDX = 8 };
enum { GX_VA_POS = 9 };
enum { GX_VA_NRM = 10 };
enum { GX_VA_CLR0 = 11 };
enum { GX_VA_CLR1 = 12 };
...
enum { GX_VA_TEX6 = 19 };
enum { GX_VA_TEX7 = 20 };
enum { GX_POSMTXARRAY = 21 };
enum { GX_NRMMTXARRAY = 22 };
enum { GX_TEXMTXARRAY = 23 };
enum { GX_LIGHTARRAY = 24 };
enum { GX_VA_NBT = 25 };
enum { GX_VA_MAXATTR = 26 };
enum { GX_VA_NULL = 0xff };
/*! @} */
 ...
 * @{
 */
enum { GX_POINTS = 0xB8 };			/*!< Draws a series of points. Each vertex is a single point. */
enum { GX_LINES = 0xA8 };			/*!< Draws a series of unconnected line segments. Each pair of vertices makes a line. */
enum { GX_LINESTRIP = 0xB0 };			/*!< Draws a series of lines. Each vertex (besides the first) makes a line between it and the previous. */
enum { GX_TRIANGLES = 0x90 };			/*!< Draws a series of unconnected triangles. Three vertices make a single triangle. */
enum { GX_TRIANGLESTRIP = 0x98 };			/*!< Draws a series of triangles. Each triangle (besides the first) shares a side with the previous triangle.
												* Each vertex (besides the first two) completes a triangle. */
enum { GX_TRIANGLEFAN = 0xA0 };			/*!< Draws a single triangle fan. The first vertex is the "centerpoint". The second and third vertex complete
...
enum { GX_QUADS = 0x80 };			/*!< Draws a series of unconnected quads. Every four vertices completes a quad. Internally, each quad is
 ...
 * @{
 */
enum { GX_LIGHT0 = 0x001 };			/*!< Light 0 */
enum { GX_LIGHT1 = 0x002 };			/*!< Light 2 */
enum { GX_LIGHT2 = 0x004 };			/*!< Light 3 */
enum { GX_LIGHT3 = 0x008 };			/*!< Light 4 */
enum { GX_LIGHT4 = 0x010 };			/*!< Light 5 */
enum { GX_LIGHT5 = 0x020 };			/*!< Light 6 */
enum { GX_LIGHT6 = 0x040 };			/*!< Light 7 */
enum { GX_LIGHT7 = 0x080 };			/*!< Light 8 */
enum { GX_MAXLIGHT = 0x100 };			/*!< All lights */
enum { GX_LIGHTNULL = 0x000 };			/*!< No lights */
/*! @} */
 ...
 * @{
 */
enum { GX_AF_SPEC = 0 };			/*!< Specular computation */
enum { GX_AF_SPOT = 1 };			/*!< Spot light attenuation */
enum { GX_AF_NONE = 2 };			/*!< No attenuation */
/*! @} */
...
enum { GX_DTTMTX10 = 94 };
enum { GX_DTTMTX11 = 97 };
enum { GX_DTTMTX12 = 100 };
enum { GX_DTTMTX13 = 103 };
enum { GX_DTTMTX14 = 106 };
enum { GX_DTTMTX15 = 109 };
enum { GX_DTTMTX16 = 112 };
enum { GX_DTTMTX17 = 115 };
enum { GX_DTTMTX18 = 118 };
enum { GX_DTTMTX19 = 121 };
enum { GX_DTTIDENTITY = 125 };
/*! @} */
 ...
 * @{
 */
enum { GX_TEXCOORD0 = 0x0 };
enum { GX_TEXCOORD1 = 0x1 };
enum { GX_TEXCOORD2 = 0x2 };
enum { GX_TEXCOORD3 = 0x3 };
enum { GX_TEXCOORD4 = 0x4 };
enum { GX_TEXCOORD5 = 0x5 };
enum { GX_TEXCOORD6 = 0x6 };
enum { GX_TEXCOORD7 = 0x7 };
enum { GX_MAXCOORD = 0x8 };
enum { GX_TEXCOORDNULL = 0xff };
/*! @} */

/* tex format */
enum { _GX_TF_ZTF = 0x10 };
enum { _GX_TF_CTF = 0x20 };
...
enum { GX_TF_IA4 = 0x2 };
enum { GX_TF_IA8 = 0x3 };
enum { GX_TF_RGB565 = 0x4 };
enum { GX_TF_RGB5A3 = 0x5 };
enum { GX_TF_RGBA8 = 0x6 };
enum { GX_TF_CI4 = 0x8 };
enum { GX_TF_CI8 = 0x9 };
enum { GX_TF_CI14 = 0xa };
enum { GX_TF_CMPR = 0xE };			/*!< Compressed */

enum { GX_TL_IA8 = 0x00 };
enum { GX_TL_RGB565 = 0x01 };
enum { GX_TL_RGB5A3 = 0x02 };

enum { GX_CTF_R4 = (0x0|_GX_TF_CTF) };			/*!< For copying 4 bits from red */
enum { GX_CTF_RA4 = (0x2|_GX_TF_CTF) };			/*!< For copying 4 bits from red, 4 bits from alpha */
enum { GX_CTF_RA8 = (0x3|_GX_TF_CTF) };			/*!< For copying 8 bits from red, 8 bits from alpha */
enum { GX_CTF_YUVA8 = (0x6|_GX_TF_CTF) };
enum { GX_CTF_A8 = (0x7|_GX_TF_CTF) };			/*!< For copying 8 bits from alpha */
enum { GX_CTF_R8 = (0x8|_GX_TF_CTF) };			/*!< For copying 8 bits from red */
enum { GX_CTF_G8 = (0x9|_GX_TF_CTF) };			/*!< For copying 8 bits from green */
enum { GX_CTF_B8 = (0xA|_GX_TF_CTF) };			/*!< For copying 8 bits from blue */
enum { GX_CTF_RG8 = (0xB|_GX_TF_CTF) };			/*!< For copying 8 bits from red, 8 bits from green */
enum { GX_CTF_GB8 = (0xC|_GX_TF_CTF) };			/*!< For copying 8 bits from green, 8 bits from blue */

/*! \addtogroup ztexfmt Z Texture format
 * @{
 */

enum { GX_TF_Z8 = (0x1|_GX_TF_ZTF) };			/*!< For texture copy, specifies upper 8 bits of Z */
enum { GX_TF_Z16 = (0x3|_GX_TF_ZTF) };			/*!< For texture copy, specifies upper 16 bits of Z */
enum { GX_TF_Z24X8 = (0x6|_GX_TF_ZTF) };			/*!< For texture copy, copies 24 Z bits and 0xFF */

/*! @} */

enum { GX_CTF_Z4 = (0x0|_GX_TF_ZTF|_GX_TF_CTF) };			/*!< For copying 4 upper bits from Z */
enum { GX_CTF_Z8M = (0x9|_GX_TF_ZTF|_GX_TF_CTF) };			/*!< For copying the middle 8 bits of Z */
enum { GX_CTF_Z8L = (0xA|_GX_TF_ZTF|_GX_TF_CTF) };			/*!< For copying the lower 8 bits of Z */
enum { GX_CTF_Z16L = (0xC|_GX_TF_ZTF|_GX_TF_CTF) };			/*!< For copying the lower 16 bits of Z */

enum { GX_TF_A8 = GX_CTF_A8 };

/*! @} */

/* gx tlut size */
enum { GX_TLUT_16 = 1 };	// number of 16 entry blocks.
enum { GX_TLUT_32 = 2 };
enum { GX_TLUT_64 = 4 };
enum { GX_TLUT_128 = 8 };
enum { GX_TLUT_256 = 16 };
...
enum { GX_TLUT_4K = 256 };
enum { GX_TLUT_8K = 512 };
enum { GX_TLUT_16K = 1024 };

/*! \addtogroup ztexop Z Texture operator
 * @{
 */

enum { GX_ZT_DISABLE = 0 };
enum { GX_ZT_ADD = 1 };			/*!< Add a Z texel to reference Z */
enum { GX_ZT_REPLACE = 2 };			/*!< Replace reference Z with Z texel */
enum { GX_MAX_ZTEXOP = 3 };
 ...
 * @{
 */
enum { GX_TG_MTX3x4 = 0 };			/*!< 2x4 matrix multiply on the input attribute and generate S,T texture coordinates. */
enum { GX_TG_MTX2x4 = 1 };			/*!< 3x4 matrix multiply on the input attribute and generate S,T,Q coordinates; S,T are then divided
										* by Q to produce the actual 2D texture coordinates. */
enum { GX_TG_BUMP0 = 2 };			/*!< Use light 0 in the bump map calculation. */
enum { GX_TG_BUMP1 = 3 };			/*!< Use light 1 in the bump map calculation. */
enum { GX_TG_BUMP2 = 4 };			/*!< Use light 2 in the bump map calculation. */
enum { GX_TG_BUMP3 = 5 };			/*!< Use light 3 in the bump map calculation. */
enum { GX_TG_BUMP4 = 6 };			/*!< Use light 4 in the bump map calculation. */
enum { GX_TG_BUMP5 = 7 };			/*!< Use light 5 in the bump map calculation. */
enum { GX_TG_BUMP6 = 8 };			/*!< Use light 6 in the bump map calculation. */
enum { GX_TG_BUMP7 = 9 };			/*!< Use light 7 in the bump map calculation. */
enum { GX_TG_SRTG = 10 };			/*!< Coordinates generated from vertex lighting results; one of the color channel results is converted
...
enum { GX_TG_TEX6 = 10 };
enum { GX_TG_TEX7 = 11 };
enum { GX_TG_TEXCOORD0 = 12 };
enum { GX_TG_TEXCOORD1 = 13 };
enum { GX_TG_TEXCOORD2 = 14 };
enum { GX_TG_TEXCOORD3 = 15 };
enum { GX_TG_TEXCOORD4 = 16 };
enum { GX_TG_TEXCOORD5 = 17 };
enum { GX_TG_TEXCOORD6 = 18 };
enum { GX_TG_COLOR0 = 19 };
enum { GX_TG_COLOR1 = 20 };
/*! @} */
...
enum { GX_REPEAT = 1 };
enum { GX_MIRROR = 2 };
enum { GX_MAXTEXWRAPMODE = 3 };

/*! \addtogroup blendmode Blending type
 * @{
 */
enum { GX_BM_NONE = 0 };			/*!< Write input directly to EFB */
enum { GX_BM_BLEND = 1 };			/*!< Blend using blending equation */
enum { GX_BM_LOGIC = 2 };			/*!< Blend using bitwise operation */
enum { GX_BM_SUBTRACT = 3 };			/*!< Input subtracts from existing pixel */
enum { GX_MAX_BLENDMODE = 4 };
/*! @} */
 ...
 * @{
 */
enum { GX_BL_ZERO = 0 };			/*!< 0.0 */
enum { GX_BL_ONE = 1 };			/*!< 1.0 */
enum { GX_BL_SRCCLR = 2 };			/*!< source color */
enum { GX_BL_INVSRCCLR = 3 };			/*!< 1.0 - (source color) */
enum { GX_BL_SRCALPHA = 4 };			/*!< source alpha */
enum { GX_BL_INVSRCALPHA = 5 };			/*!< 1.0 - (source alpha) */
enum { GX_BL_DSTALPHA = 6 };			/*!< framebuffer alpha */
enum { GX_BL_INVDSTALPHA = 7 };			/*!< 1.0 - (FB alpha) */
enum { GX_BL_DSTCLR = GX_BL_SRCCLR };
enum { GX_BL_INVDSTCLR = GX_BL_INVSRCCLR };
/*! @} */
 ...
 * @{
 */
enum { GX_LO_CLEAR = 0 };			/*!< 0 */
enum { GX_LO_AND = 1 };			/*!< src & dst */
enum { GX_LO_REVAND = 2 };			/*!< src & ~dst */
enum { GX_LO_COPY = 3 };			/*!< src */
enum { GX_LO_INVAND = 4 };			/*!< ~src & dst */
enum { GX_LO_NOOP = 5 };			/*!< dst */
enum { GX_LO_XOR = 6 };			/*!< src ^ dst */
enum { GX_LO_OR = 7 };			/*!< src | dst */
enum { GX_LO_NOR = 8 };			/*!< ~(src | dst) */
enum { GX_LO_EQUIV = 9 };			/*!< ~(src ^ dst) */
enum { GX_LO_INV = 10 };			/*!< ~dst */
enum { GX_LO_REVOR = 11 };			/*!< src | ~dst */
enum { GX_LO_INVCOPY = 12 };			/*!< ~src */
enum { GX_LO_INVOR = 13 };			/*!< ~src | dst */
enum { GX_LO_NAND = 14 };			/*!< ~(src & dst) */
enum { GX_LO_SET = 15 };			/*!< 1 */
/*! @} */
 ...
 */
enum { GX_TO_ZERO = 0 };
enum { GX_TO_SIXTEENTH = 1 };
enum { GX_TO_EIGHTH = 2 };
enum { GX_TO_FOURTH = 3 };
enum { GX_TO_HALF = 4 };
enum { GX_TO_ONE = 5 };
enum { GX_MAX_TEXOFFSET = 6 };
/*! @} */
...
enum { GX_MODULATE = 0 };			/*!< <i>Cv</i>=<i>CrCt</i>; <i>Av</i>=<i>ArAt</i> */
enum { GX_DECAL = 1 };			/*!< <i>Cv</i>=(1-<i>At</i>)<i>Cr</i> + <i>AtCt</i>; <i>Av</i>=<i>Ar</i> */
enum { GX_BLEND = 2 };			/*!< <i>Cv=(1-<i>Ct</i>)<i>Cr</i> + <i>Ct</i>; <i>Av</i>=<i>AtAr</i> */
enum { GX_REPLACE = 3 };			/*!< <i>Cv=<i>Ct</i>; <i>Ar=<i>At</i> */
enum { GX_PASSCLR = 4 };			/*!< <i>Cv=<i>Cr</i>; <i>Av=<i>Ar</i> */
...
enum { GX_CC_CPREV = 0 };				/*!< Use the color value from previous TEV stage */
enum { GX_CC_APREV = 1 };				/*!< Use the alpha value from previous TEV stage */
enum { GX_CC_C0 = 2 };				/*!< Use the color value from the color/output register 0 */
enum { GX_CC_A0 = 3 };				/*!< Use the alpha value from the color/output register 0 */
enum { GX_CC_C1 = 4 };				/*!< Use the color value from the color/output register 1 */
enum { GX_CC_A1 = 5 };				/*!< Use the alpha value from the color/output register 1 */
enum { GX_CC_C2 = 6 };				/*!< Use the color value from the color/output register 2 */
enum { GX_CC_A2 = 7 };				/*!< Use the alpha value from the color/output register 2 */
enum { GX_CC_TEXC = 8 };				/*!< Use the color value from texture */
enum { GX_CC_TEXA = 9 };				/*!< Use the alpha value from texture */
enum { GX_CC_RASC = 10 };				/*!< Use the color value from rasterizer */
enum { GX_CC_RASA = 11 };				/*!< Use the alpha value from rasterizer */
enum { GX_CC_ONE = 12 };
enum { GX_CC_HALF = 13 };
enum { GX_CC_KONST = 14 };
enum { GX_CC_ZERO = 15 };				/*!< Use to pass zero value */
...
enum { GX_CA_APREV = 0 };				/*!< Use the alpha value from previous TEV stage */
enum { GX_CA_A0 = 1 };				/*!< Use the alpha value from the color/output register 0 */
enum { GX_CA_A1 = 2 };				/*!< Use the alpha value from the color/output register 1 */
enum { GX_CA_A2 = 3 };				/*!< Use the alpha value from the color/output register 2 */
enum { GX_CA_TEXA = 4 };				/*!< Use the alpha value from texture */
enum { GX_CA_RASA = 5 };				/*!< Use the alpha value from rasterizer */
enum { GX_CA_KONST = 6 };
enum { GX_CA_ZERO = 7 };				/*!< Use to pass zero value */
...
enum { GX_TEVSTAGE8 = 8 };
enum { GX_TEVSTAGE9 = 9 };
enum { GX_TEVSTAGE10 = 10 };
enum { GX_TEVSTAGE11 = 11 };
enum { GX_TEVSTAGE12 = 12 };
enum { GX_TEVSTAGE13 = 13 };
enum { GX_TEVSTAGE14 = 14 };
enum { GX_TEVSTAGE15 = 15 };
enum { GX_MAX_TEVSTAGE = 16 };
...
enum { GX_TEV_ADD = 0 };
enum { GX_TEV_SUB = 1 };
enum { GX_TEV_COMP_R8_GT = 8 };
enum { GX_TEV_COMP_R8_EQ = 9 };
enum { GX_TEV_COMP_GR16_GT = 10 };
enum { GX_TEV_COMP_GR16_EQ = 11 };
enum { GX_TEV_COMP_BGR24_GT = 12 };
enum { GX_TEV_COMP_BGR24_EQ = 13 };
enum { GX_TEV_COMP_RGB8_GT = 14 };
enum { GX_TEV_COMP_RGB8_EQ = 15 };
enum { GX_TEV_COMP_A8_GT = GX_TEV_COMP_RGB8_GT };	 // for alpha channel
enum { GX_TEV_COMP_A8_EQ = GX_TEV_COMP_RGB8_EQ };  // for alpha channel
...
enum { GX_TB_ZERO = 0 };
enum { GX_TB_ADDHALF = 1 };
enum { GX_TB_SUBHALF = 2 };
enum { GX_MAX_TEVBIAS = 3 };
...
enum { GX_CS_SCALE_2 = 1 };
enum { GX_CS_SCALE_4 = 2 };
enum { GX_CS_DIVIDE_2 = 3 };
enum { GX_MAX_TEVSCALE = 4 };
...
enum { GX_TEVPREV = 0 };			/*!< Default register for passing results from one stage to another. */
enum { GX_TEVREG0 = 1 };
enum { GX_TEVREG1 = 2 };
enum { GX_TEVREG2 = 3 };
enum { GX_MAX_TEVREG = 4 };
 ...
 * @{
 */
enum { GX_CULL_NONE = 0 };			/*!< Do not cull any primitives. */
enum { GX_CULL_FRONT = 1 };			/*!< Cull front-facing primitives. */
enum { GX_CULL_BACK = 2 };			/*!< Cull back-facing primitives. */
enum { GX_CULL_ALL = 3 };			/*!< Cull all primitives. */
/*! @} */
 ...
 * @{
 */
enum { GX_TEXMAP0 = 0 };			/*!< Texture map slot 0 */
enum { GX_TEXMAP1 = 1 };			/*!< Texture map slot 1 */
enum { GX_TEXMAP2 = 2 };			/*!< Texture map slot 2 */
enum { GX_TEXMAP3 = 3 };			/*!< Texture map slot 3 */
enum { GX_TEXMAP4 = 4 };			/*!< Texture map slot 4 */
enum { GX_TEXMAP5 = 5 };			/*!< Texture map slot 5 */
enum { GX_TEXMAP6 = 6 };			/*!< Texture map slot 6 */
enum { GX_TEXMAP7 = 7 };			/*!< Texture map slot 7 */
enum { GX_MAX_TEXMAP = 8 };
enum { GX_TEXMAP_NULL = 0xff };			/*!< No texmap */
enum { GX_TEXMAP_DISABLE = 0x100 };			/*!< Disable texmap lookup for this texmap slot (use bitwise OR with a texture map slot). */
/*! @} */
...
enum { GX_AOP_XOR = 2 };
enum { GX_AOP_XNOR = 3 };
enum { GX_MAX_ALPHAOP = 4 };
/*! @} */

/*! \addtogroup tevkcolorid TEV constant color register
 * @{
 */
enum { GX_KCOLOR0 = 0 };			/*!< Constant register 0 */
enum { GX_KCOLOR1 = 1 };			/*!< Constant register 1 */
enum { GX_KCOLOR2 = 2 };			/*!< Constant register 2 */
enum { GX_KCOLOR3 = 3 };			/*!< Constant register 3 */
enum { GX_KCOLOR_MAX = 4 };
/*! @} */

/*! \addtogroup tevkcolorsel TEV constant color selection
 * @{
 */
enum { GX_TEV_KCSEL_1 = 0x00 };			/*!< constant 1.0 */
enum { GX_TEV_KCSEL_7_8 = 0x01 };			/*!< constant 7/8 */
enum { GX_TEV_KCSEL_3_4 = 0x02 };			/*!< constant 3/4 */
enum { GX_TEV_KCSEL_5_8 = 0x03 };			/*!< constant 5/8 */
enum { GX_TEV_KCSEL_1_2 = 0x04 };			/*!< constant 1/2 */
enum { GX_TEV_KCSEL_3_8 = 0x05 };			/*!< constant 3/8 */
enum { GX_TEV_KCSEL_1_4 = 0x06 };			/*!< constant 1/4 */
enum { GX_TEV_KCSEL_1_8 = 0x07 };			/*!< constant 1/8 */
enum { GX_TEV_KCSEL_K0 = 0x0C };			/*!< K0[RGB] register */
enum { GX_TEV_KCSEL_K1 = 0x0D };			/*!< K1[RGB] register */
enum { GX_TEV_KCSEL_K2 = 0x0E };			/*!< K2[RGB] register */
enum { GX_TEV_KCSEL_K3 = 0x0F };			/*!< K3[RGB] register */
enum { GX_TEV_KCSEL_K0_R = 0x10 };			/*!< K0[RRR] register */
enum { GX_TEV_KCSEL_K1_R = 0x11 };			/*!< K1[RRR] register */
enum { GX_TEV_KCSEL_K2_R = 0x12 };			/*!< K2[RRR] register */
enum { GX_TEV_KCSEL_K3_R = 0x13 };			/*!< K3[RRR] register */
enum { GX_TEV_KCSEL_K0_G = 0x14 };			/*!< K0[GGG] register */
enum { GX_TEV_KCSEL_K1_G = 0x15 };			/*!< K1[GGG] register */
enum { GX_TEV_KCSEL_K2_G = 0x16 };			/*!< K2[GGG] register */
enum { GX_TEV_KCSEL_K3_G = 0x17 };			/*!< K3[GGG] register */
enum { GX_TEV_KCSEL_K0_B = 0x18 };			/*!< K0[BBB] register */
enum { GX_TEV_KCSEL_K1_B = 0x19 };			/*!< K1[BBB] register */
enum { GX_TEV_KCSEL_K2_B = 0x1A };			/*!< K2[BBB] register */
enum { GX_TEV_KCSEL_K3_B = 0x1B };			/*!< K3[RBB] register */
enum { GX_TEV_KCSEL_K0_A = 0x1C };			/*!< K0[AAA] register */
enum { GX_TEV_KCSEL_K1_A = 0x1D };			/*!< K1[AAA] register */
enum { GX_TEV_KCSEL_K2_A = 0x1E };			/*!< K2[AAA] register */
enum { GX_TEV_KCSEL_K3_A = 0x1F };			/*!< K3[AAA] register */
/*! @} */

/*! \addtogroup tevkalphasel TEV constant alpha selection
 * @{
 */
enum { GX_TEV_KASEL_1 = 0x00 };			/*!< constant 1.0 */
enum { GX_TEV_KASEL_7_8 = 0x01 };			/*!< constant 7/8 */
enum { GX_TEV_KASEL_3_4 = 0x02 };			/*!< constant 3/4 */
enum { GX_TEV_KASEL_5_8 = 0x03 };			/*!< constant 5/8 */
enum { GX_TEV_KASEL_1_2 = 0x04 };			/*!< constant 1/2 */
enum { GX_TEV_KASEL_3_8 = 0x05 };			/*!< constant 3/8 */
enum { GX_TEV_KASEL_1_4 = 0x06 };			/*!< constant 1/4 */
enum { GX_TEV_KASEL_1_8 = 0x07 };			/*!< constant 1/8 */
enum { GX_TEV_KASEL_K0_R = 0x10 };			/*!< K0[R] register */
enum { GX_TEV_KASEL_K1_R = 0x11 };			/*!< K1[R] register */
enum { GX_TEV_KASEL_K2_R = 0x12 };			/*!< K2[R] register */
enum { GX_TEV_KASEL_K3_R = 0x13 };			/*!< K3[R] register */
enum { GX_TEV_KASEL_K0_G = 0x14 };			/*!< K0[G] register */
enum { GX_TEV_KASEL_K1_G = 0x15 };			/*!< K1[G] register */
enum { GX_TEV_KASEL_K2_G = 0x16 };			/*!< K2[G] register */
enum { GX_TEV_KASEL_K3_G = 0x17 };			/*!< K3[G] register */
enum { GX_TEV_KASEL_K0_B = 0x18 };			/*!< K0[B] register */
enum { GX_TEV_KASEL_K1_B = 0x19 };			/*!< K1[B] register */
enum { GX_TEV_KASEL_K2_B = 0x1A };			/*!< K2[B] register */
enum { GX_TEV_KASEL_K3_B = 0x1B };			/*!< K3[B] register */
enum { GX_TEV_KASEL_K0_A = 0x1C };			/*!< K0[A] register */
enum { GX_TEV_KASEL_K1_A = 0x1D };			/*!< K1[A] register */
enum { GX_TEV_KASEL_K2_A = 0x1E };			/*!< K2[A] register */
enum { GX_TEV_KASEL_K3_A = 0x1F };			/*!< K3[A] register */
/*! @} */
 ...
 * @{
 */
enum { GX_INDTEXSTAGE0 = 0 };
enum { GX_INDTEXSTAGE1 = 1 };
enum { GX_INDTEXSTAGE2 = 2 };
enum { GX_INDTEXSTAGE3 = 3 };
enum { GX_MAX_INDTEXSTAGE = 4 };
/*! @} */
...
enum { GX_ITB_TU = 6 };
enum { GX_ITB_STU = 7 };
enum { GX_MAX_ITBIAS = 8 };
/*! @} */

/*! \addtogroup indtexmtx Indirect texture matrix
 * @{
 */
enum { GX_ITM_OFF = 0 };			/*!< Specifies a matrix of all zeroes. */
enum { GX_ITM_0 = 1 };			/*!< Specifies indirect matrix 0, indirect scale 0. */
enum { GX_ITM_1 = 2 };			/*!< Specifies indirect matrix 1, indirect scale 1. */
enum { GX_ITM_2 = 3 };			/*!< Specifies indirect matrix 2, indirect scale 2. */
enum { GX_ITM_S0 = 5 };			/*!< Specifies dynamic S-type matrix, indirect scale 0. */
enum { GX_ITM_S1 = 6 };			/*!< Specifies dynamic S-type matrix, indirect scale 1. */
enum { GX_ITM_S2 = 7 };			/*!< Specifies dynamic S-type matrix, indirect scale 2. */
enum { GX_ITM_T0 = 9 };			/*!< Specifies dynamic T-type matrix, indirect scale 0. */
enum { GX_ITM_T1 = 10 };			/*!< Specifies dynamic T-type matrix, indirect scale 1. */
enum { GX_ITM_T2 = 11 };			/*!< Specifies dynamic T-type matrix, indirect scale 2. */
/*! @} */
...
enum { GX_FOG_PERSP_LIN = 2 };
enum { GX_FOG_PERSP_EXP = 4 };
enum { GX_FOG_PERSP_EXP2 = 5 };
enum { GX_FOG_PERSP_REVEXP = 6 };
enum { GX_FOG_PERSP_REVEXP2 = 7 };

enum { GX_FOG_ORTHO_LIN = 10 };
enum { GX_FOG_ORTHO_EXP = 12 };
enum { GX_FOG_ORTHO_EXP2 = 13 };
enum { GX_FOG_ORTHO_REVEXP = 14 };
enum { GX_FOG_ORTHO_REVEXP2 = 15 };

enum { GX_FOG_LIN = GX_FOG_PERSP_LIN };
enum { GX_FOG_EXP = GX_FOG_PERSP_EXP };
enum { GX_FOG_EXP2 = GX_FOG_PERSP_EXP2 };
enum { GX_FOG_REVEXP = GX_FOG_PERSP_REVEXP };
enum { GX_FOG_REVEXP2 = GX_FOG_PERSP_REVEXP2 };
/*! @} */


/* pixel format */
enum { GX_PF_RGB8_Z24 = 0 };
enum { GX_PF_RGBA6_Z24 = 1 };
enum { GX_PF_RGB565_Z16 = 2 };
enum { GX_PF_Z24 = 3 };
enum { GX_PF_Y8 = 4 };
enum { GX_PF_U8 = 5 };
enum { GX_PF_V8 = 6 };
...
enum { GX_CLAMP_NONE = 0 };
enum { GX_CLAMP_TOP = 1 };
enum { GX_CLAMP_BOTTOM = 2 };
 ...
 * @{
 */
enum { GX_COPY_PROGRESSIVE = 0 };
enum { GX_COPY_INTLC_EVEN = 2 };
enum { GX_COPY_INTLC_ODD = 3 };
/*! @} */

/*! \addtogroup alphareadmode Alpha read mode
 * @{
 */
enum { GX_READ_00 = 0 };			/*!< Always read 0x00. */
enum { GX_READ_FF = 1 };			/*!< Always read 0xFF. */
enum { GX_READ_NONE = 2 };			/*!< Always read the real alpha value. */
/*! @} */
 ...
 * @{
 */
enum { GX_TEXCACHE_32K = 0 };
enum { GX_TEXCACHE_128K = 1 };
enum { GX_TEXCACHE_512K = 2 };
enum { GX_TEXCACHE_NONE = 3 };
/*! @} */
 ...
 * @{
 */
enum { GX_NEAR = 0 };			/*!< Point sampling, no mipmap */
enum { GX_LINEAR = 1 };			/*!< Bilinear filtering, no mipmap */
enum { GX_NEAR_MIP_NEAR = 2 };			/*!< Point sampling, discrete mipmap */
enum { GX_LIN_MIP_NEAR = 3 };			/*!< Bilinear filtering, discrete mipmap */
enum { GX_NEAR_MIP_LIN = 4 };			/*!< Point sampling, linear mipmap */
enum { GX_LIN_MIP_LIN = 5 };			/*!< Trilinear filtering */
/*! @} */
 ...
 * @{
 */
enum { GX_PERF0_VERTICES = 0 };			/*!< Number of vertices processed by the GP. */
enum { GX_PERF0_CLIP_VTX = 1 };			/*!< Number of vertices that were clipped by the GP. */
enum { GX_PERF0_CLIP_CLKS = 2 };			/*!< Number of GP clocks spent clipping. */
enum { GX_PERF0_XF_WAIT_IN = 3 };			/*!< Number of cycles the XF is waiting on input. If the XF is waiting a large percentage
													* of the total time, it may indicate that the CPU is not supplying data fast enough to
													* keep the GP busy. */
enum { GX_PERF0_XF_WAIT_OUT = 4 };			/*!< Number of cycles the XF waits to send its output to the rest of the GP pipeline. If
													* the XF cannot output, it may indicate that the GP is currently fill-rate limited. */
enum { GX_PERF0_XF_XFRM_CLKS = 5 };			/*!< Number of cycles the transform engine is busy. */
enum { GX_PERF0_XF_LIT_CLKS = 6 };			/*!< Number of cycles the lighting engine is busy. */
enum { GX_PERF0_XF_BOT_CLKS = 7 };			/*!< Number of cycles the bottom of the pipe (result combiner) is busy. */
enum { GX_PERF0_XF_REGLD_CLKS = 8 };			/*!< Number of cycles are spent loading XF state registers. */
enum { GX_PERF0_XF_REGRD_CLKS = 9 };			/*!< Number of cycles the XF reads the state registers. */
enum { GX_PERF0_CLIP_RATIO = 10 };
enum { GX_PERF0_TRIANGLES = 11 };			/*!< Number of triangles. */
enum { GX_PERF0_TRIANGLES_CULLED = 12 };			/*!< Number of triangles that <i>failed</i> the front-face/back-face culling test. */
enum { GX_PERF0_TRIANGLES_PASSED = 13 };			/*!< Number of triangles that <i>passed</i> the front-face/back-face culling test. */
enum { GX_PERF0_TRIANGLES_SCISSORED = 14 };			/*!< Number of triangles that are scissored. */
enum { GX_PERF0_TRIANGLES_0TEX = 15 };
enum { GX_PERF0_TRIANGLES_1TEX = 16 };
enum { GX_PERF0_TRIANGLES_2TEX = 17 };
enum { GX_PERF0_TRIANGLES_3TEX = 18 };
enum { GX_PERF0_TRIANGLES_4TEX = 19 };
enum { GX_PERF0_TRIANGLES_5TEX = 20 };
enum { GX_PERF0_TRIANGLES_6TEX = 21 };
enum { GX_PERF0_TRIANGLES_7TEX = 22 };
enum { GX_PERF0_TRIANGLES_8TEX = 23 };
enum { GX_PERF0_TRIANGLES_0CLR = 24 };
enum { GX_PERF0_TRIANGLES_1CLR = 25 };
enum { GX_PERF0_TRIANGLES_2CLR = 26 };
enum { GX_PERF0_QUAD_0CVG = 27 };			/*!< Number of quads having zero coverage. */
enum { GX_PERF0_QUAD_NON0CVG = 28 };			/*!< Number of quads having coverage greater than zero. */
enum { GX_PERF0_QUAD_1CVG = 29 };			/*!< Number of quads with 1 pixel coverage. */
enum { GX_PERF0_QUAD_2CVG = 30 };			/*!< Number of quads with 2 pixel coverage. */
enum { GX_PERF0_QUAD_3CVG = 31 };			/*!< Number of quads with 3 pixel coverage. */
enum { GX_PERF0_QUAD_4CVG = 32 };			/*!< Number of quads with 4 pixel coverage. */
enum { GX_PERF0_AVG_QUAD_CNT = 33 };			/*!< Average quad count; average based on what is unknown */
enum { GX_PERF0_CLOCKS = 34 };			/*!< Number of GP clocks that have elapsed since the previous call to GX_ReadGP0Metric(). */
enum { GX_PERF0_NONE = 35 };			/*!< Disables performance measurement for perf0 and resets the counter. */
/*! @} */
 ...
 * @{
 */
enum { GX_PERF1_TEXELS = 0 };			/*!< Number of texels processed by the GP. */
enum { GX_PERF1_TX_IDLE = 1 };			/*!< Number of clocks that the texture unit (TX) is idle. */
enum { GX_PERF1_TX_REGS = 2 };			/*!< Number of GP clocks spent writing to state registers in the TX unit. */
enum { GX_PERF1_TX_MEMSTALL = 3 };			/*!< Number of GP clocks the TX unit is stalled waiting for main memory. */
enum { GX_PERF1_TC_CHECK1_2 = 4 };
enum { GX_PERF1_TC_CHECK3_4 = 5 };
enum { GX_PERF1_TC_CHECK5_6 = 6 };
enum { GX_PERF1_TC_CHECK7_8 = 7 };
enum { GX_PERF1_TC_MISS = 8 };			/*!< Number of texture cache misses in total? */
enum { GX_PERF1_VC_ELEMQ_FULL = 9 };
enum { GX_PERF1_VC_MISSQ_FULL = 10 };
enum { GX_PERF1_VC_MEMREQ_FULL = 11 };
enum { GX_PERF1_VC_STATUS7 = 12 };
enum { GX_PERF1_VC_MISSREP_FULL = 13 };
enum { GX_PERF1_VC_STREAMBUF_LOW = 14 };
enum { GX_PERF1_VC_ALL_STALLS = 15 };
enum { GX_PERF1_VERTICES = 16 };			/*!< Number of vertices processed by the GP. */
enum { GX_PERF1_FIFO_REQ = 17 };			/*!< Number of lines (32B) read from the GP FIFO. */
enum { GX_PERF1_CALL_REQ = 18 };			/*!< Number of lines (32B) read from called display lists. */
enum { GX_PERF1_VC_MISS_REQ = 19 };			/*!< Number vertex cache miss request. Each miss requests a 32B transfer from main memory. */
enum { GX_PERF1_CP_ALL_REQ = 20 };			/*!< Counts all requests (32B/request) from the GP Command Processor (CP). It should be equal to
													* the sum of counts returned by <tt>GX_PERF1_FIFO_REQ</tt>, <tt>GX_PERF1_CALL_REQ</tt>, and <tt>GX_PERF1_VC_MISS_REQ</tt>. */
enum { GX_PERF1_CLOCKS = 21 };			/*!< Number of GP clocks that have elapsed since the last call to GX_ReadGP1Metric(). */
enum { GX_PERF1_NONE = 22 };			/*!< Disables performance measurement for perf1 and resets the counter. */
/*! @} */
...
enum { GX_MAX_VTXDESC = GX_VA_MAXATTR };
enum { GX_MAX_VTXDESC_LISTSIZE = (GX_VA_MAXATTR+1) };

enum { GX_MAX_VTXATTRFMT = GX_VA_MAXATTR };
enum { GX_MAX_VTXATTRFMT_LISTSIZE = (GX_VA_MAXATTR+1) };

enum { GX_MAX_Z24 = 0x00ffffff };
...
function GX.GX_InitLightPosv(lo,vec)
    return GX.GX_InitLightPos(lo, ffi.cast('f32*',vec)[0], ffi.cast('f32*',vec)[1], ffi.cast('f32*'vec)[2])
end
function GX.GX_InitLightDirv(lo,vec)
    return GX.GX_InitLightDir(lo, ffi.cast('f32*',vec)[0], ffi.cast('f32*',vec)[1], ffi.cast('f32*'vec)[2])
end
function GX.GX_InitSpecularDirv(lo,vec)
    return GX.GX_InitSpecularDir(lo, ffi.cast('f32*',vec)[0], ffi.cast('f32*',vec)[1], ffi.cast('f32*'vec)[2])
end
function GX.GX_InitSpecularDirHAv(lo,vec0,vec1)
    return GX.GX_InitSpecularDirHA(lo,
		ffi.cast('f32*',vec0)[0], ffi.cast('f32*',vec0)[1], ffi.cast('f32*'vec0)[2],
		ffi.cast('f32*',vec1)[0], ffi.cast('f32*',vec1)[1], ffi.cast('f32*'vec1)[2]
	)
end
function GX.GX_InitLightShininess(lobj, shininess)
	return GX.GX_InitLightAttn(lobj, 0.0, 0.0, 1.0, shininess/2.0, 0.0, 1.0-shininess/2.0)
end

return setmetatable(GX, {__index=ffi.C})
